...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-05-2024 a las 23:10:42
...
INSERT INTO `ciudades` (`Id_ciudad`, `Id_estado`, `Estado`, `Capital`) VALUES
(1, 1, 'Maroa', 0),
...
INSERT INTO `cliente` (`Id_cliente`, `Primer_Nombre`, `Segundo_Nombre`, `Primer_apellido`, `Segundo_apellido`, `Tipo_de_cedula`, `Cedula`, `Dirección`, `Telefono`, `Correo`, `Usuario`, `Contraseña`, `Status`, `genero`) VALUES
(1, 'Sofia', 'Alejandra', 'Rodriguez', 'Gomez', '', '28798678', 'la orquidea, calle 2 ', '2147483647', 'Sorf@gmail.com', 'sofir2', 'd051351207a64f8298e31b233df218cdcc', 'Activo', 'masculino'),
(2, 'Alejandro', 'Jose', 'Peres', 'Zambrano', 'Venezolano', '31678900', 'Piedras blancas', '04129977878', 'alejo89@gmail.com', 'AlejoP', 'aljo0909', 'Activo', 'masculino'),
(3, '', '', '', '', 'Venezolano', '', '', '', '', '', '', 'Activo', 'femenino'),
(4, 'juangel', '', 'apostol', '', 'Venezolano', '1345678', '', '134567', 'juangel.18@gmail.com', '', '', 'Activo', 'femenino'),
(5, '', '', '', '', 'Venezolano', '', '', '', '', '', '', 'Activo', 'femenino'),
(6, 'juangel', '', 'sanchez', '', 'Venezolano', '28220429', '', '123456787', 'juangel.18@gmail.com', '', '', 'Activo', 'femenino'),
(8, 'Roberto', '', 'Ruíz', '', 'Venezolano', '14512772', '', '1234567', 'robertoruiz.1@gmail.com', '', '', 'Activo', 'masculino'),
(9, '', '', '', '', 'Venezolano', '', '', '', '', '', '', 'Activo', 'femenino'),
(10, 'Yonaire', '', 'Sanchez', '', 'Venezolano', '30227004', '', '04125201342', 'yona.227@gmail.com', '', '', 'Activo', 'femenino');
...
CREATE TABLE `comentario` (
  ...
  `Id_articulo` int(11) NOT NULL,
  `Comentario` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `Fecha` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `estado` (`Id_estado`, `Nombre`, `iso_3166-2`) VALUES
(1, 'Amazonas', 'VE-X'),
(2, 'Anzoátegui', 'VE-B'),
(3, 'Apure', 'VE-C'),
(4, 'Aragua', 'VE-D'),
...
CREATE TABLE `lista_de_deseos` (
  ...
  `ID_Cliente` int(11) NOT NULL,
  `Nombre_Artículo` varchar(100) NOT NULL,
  `Precio_Artículo` decimal(10,2) NOT NULL,
...
CREATE TABLE `marca` (
  `Id_marca` int(11) NOT NULL,
  `Nombre` varchar(60) NOT NULL,
  `Características` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `parroquia` (`Id_parroquia`, `Municipio`, `Parroquia`) VALUES
(1, '1', 'Alto Orinoco'),
...
CREATE TABLE `pedido` (
  ...
  `Id_usuario` int(11) NOT NULL,
  `Estado_pedido` enum('Pendiente','Proceso','Enviado','Entregado') NOT NULL,
  `Fecha` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `tabla_de_reportes`
--

CREATE TABLE `tabla_de_reportes` (
  `ID_Repostes` int(11) NOT NULL,
  `Tipo_de_Reporte` varchar(50) NOT NULL,
  `Fecha_de_generación` date NOT NULL,
  `Datos_Relevantes_Reporte` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `tabla_de_reportes`
--
ALTER TABLE `tabla_de_reportes`
  ADD PRIMARY KEY (`ID_Repostes`);
...
--
ALTER TABLE `lista_de_deseos`
  MODIFY `ID_Lista_Deseos` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tabla_de_reportes`
--
ALTER TABLE `tabla_de_reportes`
  MODIFY `ID_Repostes` int(11) NOT NULL AUTO_INCREMENT;
