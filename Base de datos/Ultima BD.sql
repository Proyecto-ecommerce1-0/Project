...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-06-2024 a las 05:03:07
...
CREATE TABLE `favorito` (
  ...
  `Id_producto` int(11) NOT NULL,
  `cantida_producto` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `productos` (`Id_producto`, `Nombre`, `Codigo`, `Descripcion_corta`, `Descripcion_larga`, `Caracteristicas`, `Precio`, `Status`) VALUES
(1, 'libreta', '123', 'negra de una linea', 'buena bonita, color negra, de buena calidad', '', 2.00, 'Disponible'),
(2, 'lapicer', '', 'o', '', '', 1.00, '');
