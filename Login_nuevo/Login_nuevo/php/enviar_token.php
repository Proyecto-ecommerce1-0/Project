...
try {
    ...
    $mail->addAddress('yohanderramos0@gmail.com', 'yohander');    
    $mail->isHTML(true);                                  
    $mail->Subject = 'Recuperación de contraseña';
    $mail->Body    = 'Hola este es un correo generado para solicitar tu recuperación de contraseña.
     Por favor, visita la página <a href="http://localhost:3000/Restablecer%20contraseña.php?id='.$row['id'].'"> Recuperación de contraseña</a> ';
