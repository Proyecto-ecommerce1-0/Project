    ...
    <div class="Admin">
        ...
        <div class="container-modulos">    
            <div class="modulos-box">
                <img src="/Admin/Imagenes/productos.png" alt="Modulo productos">
                <a class="btn" href="login.html">PRODUCTOS</a>
            </div>

            <div class="modulos-box">
                <img src="/Admin/Imagenes/productos.png" alt="Modulo productos">
                <a class="btn" href="login.html">ORDENES</a>
            </div>

            <div class="modulos-box">
                <img src="/Admin/Imagenes/productos.png" alt="Modulo productos">
                <a class="btn" href="login.html">REPORTES</a>
            </div>
