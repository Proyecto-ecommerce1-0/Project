...
<body>
    <div class="container-form register  ">
        <div class="information">
            <div class="info-childs">
                ...
                <input type="button" value="Iniciar Sesion como Admi"  id="sign-in">
                
            </div>
        </div>
        <div class="form-information">
            <div class="form-information-childs">
                <h2>Crear una Cuenta como Admi</h2>
               <div class="icons">
                ...
                <form action="../Admi/Registroadmi.php" method="POST" class="form">
                    <!--Grupo: Nombre-->
                    ...
                    <div class="contenedor-seleccion">
                        ...
                        const generoSeleccionado = generoSelect.value;
                         ...
                         // Enviar la selección al servidor usando AJAX
                          ...
                          xhr.open('POST', '../Admi/Registroadmi.php'); 
    ...
    <div class="container-form login hide">
        ...
        <div class="form-information">
            <div class="form-information-childs">
                <h2>Iniciar Sesion de Admi</h2>
               <div class="icons">
                <i class='bx bxl-google-plus-circle'></i>
               </div>
                <p>O Iniciar Session con una cuenta</p>
                <form class="form" action= "/Project_nuevo/Admi/php_Admi/inicio_sesionAdmi.php" method="POST">
                    <label>
                        <i class='bx bx-envelope'></i>
